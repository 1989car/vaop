                ...
                <div class="kt-container">
                    ...
                    <div class="kt-header__topbar kt-grid__item">
                        ...
                        <div class="kt-header__topbar-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                                <form>
                                    ...
                                    <!--begin: Head -->
                                    <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(https://assets.vaop.flightsim.aero/media/misc/bg-1.jpg)">
                        ...
                        <div class="kt-header__topbar-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                                <form>
                                    ...
                                    <!--begin: Head -->
                                    <div class="kt-head kt-head--skin-dark" style="background-image: url(https://assets.vaop.flightsim.aero/media/misc/bg-1.jpg)">
                                        <h3 class="kt-head__title">
                                            User Quick Actions
                        ...
                        <div class="kt-header__topbar-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                                <form>
                                    ...
                                    <!-- begin:: Mycart -->
                                    <div class="kt-mycart">
                                        <div class="kt-mycart__head kt-head" style="background-image: url(https://assets.vaop.flightsim.aero/media/misc/bg-1.jpg);">
                                            ...
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="https://assets.vaop.flightsim.aero/media/products/product9.jpg" title="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="https://assets.vaop.flightsim.aero/media/products/product13.jpg" title="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="https://assets.vaop.flightsim.aero/media/products/product16.jpg" title="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="https://assets.vaop.flightsim.aero/media/products/product15.jpg" title="" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
										<span class="kt-header__topbar-icon">
											<img class="" src="https://assets.vaop.flightsim.aero/media/flags/020-flag.svg" alt="" />
										</span>
                            </div>
                                ...
                                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                    <li class="kt-nav__item kt-nav__item--active">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-icon"><img src="https://assets.vaop.flightsim.aero/media/flags/020-flag.svg" alt="" /></span>
                                            <span class="kt-nav__link-text">English</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-icon"><img src="https://assets.vaop.flightsim.aero/media/flags/016-spain.svg" alt="" /></span>
                                            <span class="kt-nav__link-text">Spanish</span>
                                        </a>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="#" class="kt-nav__link">
                                            <span class="kt-nav__link-icon"><img src="https://assets.vaop.flightsim.aero/media/flags/017-germany.svg" alt="" /></span>
                        ...
                        <div class="kt-header__topbar-item kt-header__topbar-item--user">
                            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                ...
                                <img alt="Pic" src="https://assets.vaop.flightsim.aero/media/users/300_21.jpg" class="kt-hidden" />
                            </div>
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">

                                <!--begin: Head -->
                                <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(https://assets.vaop.flightsim.aero/media/misc/bg-1.jpg)">
                                    <div class="kt-user-card__avatar">
                                        <img class="kt-hidden" alt="Pic" src="https://assets.vaop.flightsim.aero/media/users/300_25.jpg" />
                                                ...
                                                <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                                                    ...
                                                    <div class="kt-timeline-v2__item">
                                                        ...
                                                        <div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
                                                            <a href="#"><img src="https://assets.vaop.flightsim.aero/media/users/100_4.jpg" title=""></a>
                                                            <a href="#"><img src="https://assets.vaop.flightsim.aero/media/users/100_13.jpg" title=""></a>
                                                            <a href="#"><img src="https://assets.vaop.flightsim.aero/media/users/100_11.jpg" title=""></a>
                                                            <a href="#"><img src="https://assets.vaop.flightsim.aero/media/users/100_14.jpg" title=""></a>
                                                        </div>
                                                    </div>
                                                    <div class="kt-timeline-v2__item">
                                                ...
                                                <div class="kt-widget4__items kt-widget4__items--bottom kt-portlet__space-x kt-margin-b-20">
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__img kt-widget4__img--logo">
                                                            <img src="https://assets.vaop.flightsim.aero/media/client-logos/logo3.png" alt="">
                                                        </div>
                                                    ...
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__img kt-widget4__img--logo">
                                                            <img src="https://assets.vaop.flightsim.aero/media/client-logos/logo1.png" alt="">
                                                        </div>
                                                        <div class="kt-widget4__info">
                                                            <a href="#" class="kt-widget4__title">
                                                                FlyThemes
                                                    ...
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__img kt-widget4__img--logo">
                                                            <img src="https://assets.vaop.flightsim.aero/media/client-logos/logo2.png" alt="">
                                                        </div>
                                                        <div class="kt-widget4__info">
                                                            <a href="#" class="kt-widget4__title">
                                                                AirApp
